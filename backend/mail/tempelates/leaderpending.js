exports.leaderPending = (email, teamName) => {
  return `<!DOCTYPE html>
    <html>
   ...
   <body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p>Thank you for registering yourself and your team ${teamName} for our event.</p>
            <p>Please note that your registration is currently pending verification by our team.</p>
